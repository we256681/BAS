<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		...
		value_string: "",
		help: {
			description: tr("The id of the message which need to be moved from one mailbox folder to another. If a list is specified instead of one message id, then all messages from the specified list will be moved") + ", " + tr("as a list, you can use a string consisting of id, separated by commas."),
			examples: [
				{code: 134},
				{code: "263,339"},
				{code: "145, 187, 422"},
	...
	<%= _.template($('#input_constructor').html())({
		...
		value_string: "",
		help: {
			description: tr("The name of the folder where the message or several messages will be moved."),
			examples: [
