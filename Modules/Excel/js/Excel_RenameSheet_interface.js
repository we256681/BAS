...
<%= _.template($('#input_constructor').html())({id:"NewSheetName", description: tr("New sheet name"), default_selector: "string", disable_int:true, value_string: "", help: {description:tr("New sheet name."),examples:[{code:tr("Sheet1")}, {code:tr("Sheet2")}, {code:tr("New Sheet")}]} }) %>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Rename the specified sheet in excel file.</div>
