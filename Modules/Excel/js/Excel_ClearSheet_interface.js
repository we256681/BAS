...
<%= _.template($('#input_constructor').html())({id:"SheetIndexOrName", description: tr("Sheet index or name"), default_selector: "int", value_number: 0, min_number:-1, max_number:999999, help: {description: tr("Index or sheet name in excel file."),examples:[{code:-1, description: tr("Clear all sheets")}, {code:0, description: tr("First sheet index")}, {code:1, description: tr("Second sheet index")}, {code:tr("Sheet1"), description: tr("First sheet name")}, {code:tr("Sheet2"), description: tr("Second sheet name")}]} }) %>
</div>
<div class="tooltipinternal">
	...
	<div class="tr tooltip-paragraph-fold">To clear all sheets need to specify <code>-1</code> as the index sheet.</div>
