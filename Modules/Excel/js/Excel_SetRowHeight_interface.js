...
<%= _.template($('#input_constructor').html())({id:"Height", description: tr("Height"), default_selector: "int", value_number: "", min_number:0, max_number:999999, help: {description: tr("The height which needs to be set.")} }) %>
</div>
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Set height for row on specified excel file.</div>
