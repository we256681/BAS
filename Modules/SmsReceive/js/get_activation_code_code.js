...
_if(_SMS_CONFIRM_DATA["method"] == "sms-activate.ru" || _SMS_CONFIRM_DATA["method"] == "getsms.online", function(){
    ...
    _if_else(_SMS_CONFIRM_DATA["not_first"], function(){
        _call(_BAS_SMSACTIVATEPIREQUEST,{domain: _SMS_CONFIRM_DATA["domain"], api_key: _SMS_CONFIRM_DATA["api"], action: "setStatus", status: "3", id: _SMS_CONFIRM_DATA["id"]})!
        var arr = _result()
        ...
        _call(_BAS_SMSACTIVATEPIREQUEST,{domain: _SMS_CONFIRM_DATA["domain"], api_key: _SMS_CONFIRM_DATA["api"], action: "setStatus", status: "1", id: _SMS_CONFIRM_DATA["id"]})!
        var arr = _result()
        if(arr[0].indexOf("ACCESS_") != 0)
        {
    ...
    _do(function(){
        ...
        _call(_BAS_SMSACTIVATEPIREQUEST,{domain: _SMS_CONFIRM_DATA["domain"], api_key: _SMS_CONFIRM_DATA["api"], action: "getStatus", id: _SMS_CONFIRM_DATA["id"]})!
