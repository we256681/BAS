...
namespace BrowserAutomationStudioFramework
{
    ...
    QPushButton * AskUserForResourcesDialog::AddSchedulerButton()
    {
        QPushButton *SchedulerButton = ui->buttonBox->addButton("",QDialogButtonBox::ResetRole);
        connect(SchedulerButton, SIGNAL(clicked()),this,SIGNAL(ShowScheduler()));
