...
namespace BrowserAutomationStudioFramework
{
    ...
    public:
        ...
        virtual DatabaseItem Select(const QString& Id, int TableId);
        ...
        virtual void Update(DatabaseItem Item, DatabaseMassSelector Selector);
        ...
        virtual DatabaseSelector ConvertToDatabaseSelector(const QVariant& Data);


    signals:
        //void TerminateProcess();
        void AddConnectionLog(QString Log);
