...
namespace BrowserAutomationStudioFramework
{
    ...
    void SubprocessWebElement::ConnectElement(IWorker* Worker, IWebElement* Element)
    {
        disconnect(Worker->GetProcessComunicatorActual(),SIGNAL(Received(QString)),Element,SLOT(Received(QString)));
        connect(Worker->GetProcessComunicatorActual(),SIGNAL(Received(QString)),Element,SLOT(Received(QString)));
        disconnect(Worker->GetProcessComunicator(),SIGNAL(Received(QString)),Element,SLOT(Received(QString)));
    ...
    void SubprocessWebElement::xml(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("xml"));
    }
    ...
    void SubprocessWebElement::text(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("text"));
    }
    ...
    void SubprocessWebElement::random_point(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("random_point"));
    }
    ...
    void SubprocessWebElement::RunScriptAsync(const QString& javascript, const QObject *object_success,const char * slot_success)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("javascript",javascript));
    }
    ...
    void SubprocessWebElement::click(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("click"));
    }
    ...
    void SubprocessWebElement::system_click(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("system_click"));
    }
    ...
    void SubprocessWebElement::system_click_up(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("system_click_up"));
    }
    ...
    void SubprocessWebElement::system_click_down(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("system_click_down"));
    }
    ...
    void SubprocessWebElement::move(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("move"));
    }
    ...
    void SubprocessWebElement::clear(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("clear"));
    }
    void SubprocessWebElement::type(const QString& text, int interval, const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("type",text, QString::number(interval)));
    }
    void SubprocessWebElement::clarify(int x, int y, const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("clarify",QString::number(x), QString::number(y)));
    }
    ...
    void SubprocessWebElement::fill(const QString& text, const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("fill",text));
    }
    void SubprocessWebElement::exist(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("exist"));
    }
    void SubprocessWebElement::submit(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("submit"));
    }
    void SubprocessWebElement::style(const QString& text, const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("style", text));
    }
    void SubprocessWebElement::check(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("check"));
    }
    void SubprocessWebElement::focus(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("focus"));
    }
    void SubprocessWebElement::set(const QString& text,const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("set",text));
    }
    void SubprocessWebElement::set_integer(int index,const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("set_integer", QString::number(index)));
    }
    void SubprocessWebElement::set_random(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("set_random"));
    }
    void SubprocessWebElement::attr(const QString& text,const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("attr", text));
    }
    void SubprocessWebElement::set_attr(const QString& val,const QString& text,const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("set_attr", val, text));
    }
    ...
    void SubprocessWebElement::length(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("length"));
    }

    void SubprocessWebElement::highlight(const QString& path, const QString& callback)
    {
        Worker->SetScript(PrepareCallback(callback));
        ...
        Worker->GetProcessComunicator()->Send(CreateXmlElement("highlight", path));
    }
    ...
    void SubprocessWebElement::render_file(const QString& path,const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("render_file", path));
    }
    void SubprocessWebElement::render_base64(const QString& callback)
    {
        ...
        Worker->GetProcessComunicatorActual()->Send(CreateXmlElement("render_base64"));
    }
