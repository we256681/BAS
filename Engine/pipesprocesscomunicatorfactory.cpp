...
namespace BrowserAutomationStudioFramework
{
    ...
    PipesProcessComunicatorFactory::PipesProcessComunicatorFactory(QObject *parent) :
    ...
    void PipesProcessComunicatorFactory::NewConnection()
    {
        ...
        LocalServerData Data = std::make_shared<PipesProcessComunicatorFactory::LocalServerDataClass>();
    ...
    QLocalSocket * PipesProcessComunicatorFactory::FindLocalServerByKey(const QString& Key)
    {
    ...
    void PipesProcessComunicatorFactory::Send(const QString& key, const QString& data)
    {
    ...
    void PipesProcessComunicatorFactory::Finished()
    {
    ...
    void PipesProcessComunicatorFactory::Income()
    {
        QLocalSocket *Client = (QLocalSocket *)(sender());
    ...
    IProcessComunicator * PipesProcessComunicatorFactory::CreateProcessComunicator(const QString& BrowserEngine)
    {
    ...
    void PipesProcessComunicatorFactory::SetLogger(ILogger * Logger)
    {

    }

    void PipesProcessComunicatorFactory::SetCommandLineParams(const QStringList& Params)
    {
        this->Params = Params;
    }
