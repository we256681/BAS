...
{
    DesignResourceWidget::DesignResourceWidget(QWidget *parent,IResourceWidget * Wrapper) :
        QGroupBox(parent),
    ...
    IResourceWidget * DesignResourceWidget::GetWrapper()
    {
        return Wrapper;
    }

    QList<int> DesignResourceWidget::GetDatabaseColumnsIds()
    {
        return ui->MoreChooserWidget->GetDatabaseColumnsIds();
    }

    void DesignResourceWidget::SetDatabaseColumnsIds(const QList<int>& ColumnsIds)
    {
        ui->MoreChooserWidget->SetDatabaseColumnsIds(ColumnsIds);
    }

    void DesignResourceWidget::RenderAdvanced()
    {
        ui->ChooserWidget->RenderAdvanced();
    }
