...
namespace BrowserAutomationStudioFramework
{
    ...
    public slots:
        ...
        virtual void SearchMessages(const QString& Sender,const QString& Subject,const QString& Body,const QString& To);
        ...
        virtual QString GenerateUrl(QtCUrl::OptionItems& options);
    ...
    private slots:
        ...
        void SetProxyToCurl(QtCUrl::OptionItems& options);
