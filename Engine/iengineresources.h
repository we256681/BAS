...
namespace BrowserAutomationStudioFramework
{
    ...
    public:
        ...
        virtual QJsonValue GetDescription(const QString & name) = 0;
        ...
        virtual void Clear(const QString & name) = 0;
        virtual void RemoveIndex(const QString & name,int index) = 0;
        virtual int Find(const QString & name,const QString& value) = 0;
        virtual QList<int> FindByKeys(const QString & name,const QStringList& keys) = 0;
