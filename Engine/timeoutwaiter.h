...
namespace BrowserAutomationStudioFramework
{
    class ENGINESHARED_EXPORT TimeoutWaiter : public IWaiter
    {
        ...
        //QTimer *Timer;
        bool IsAborted;
        int WaitingForResourceIteration;
        ...
        bool IsReportAboutStartedOrEnded;
        //QTimer *GetTimer();
    ...
    public slots:
        virtual void WaitForSignal(const QObject *object_wait, const char * slot_signal ,const QObject *object_success,const char * slot_success,const QObject *object_fail,const char * slot_fail, int ExactTimeout = -1);
        ...
        virtual void SetReportAboutStartedOrEnded();
        virtual bool GetReportAboutStartedOrEnded();
        virtual int PeekGeneralWait();
    private slots:
