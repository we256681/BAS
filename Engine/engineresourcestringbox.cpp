...
namespace BrowserAutomationStudioFramework
{
    ...
    void EngineResourceStringBox::RemoveIndex(int index)
    {
        Box->RemoveIndex(index);
    }

    int EngineResourceStringBox::Find(const QString& value)
    {
        return Box->Find(value);
    }

    QList<int> EngineResourceStringBox::FindByKeys(const QStringList& keys)
    {
        return Box->FindByKeys(keys);
    }
    ...
    void EngineResourceStringBox::SyncNotForce()
    {
        emit SyncedNotForce();
    }

    void EngineResourceStringBox::Clear()
    {
        Box->Clear();
    }
