...
QList<int> DesignChooserResourceWidget::GetOriginalDatabaseColumnsIds()
{
    return OriginalDatabaseColumnsIds;
}

int DesignChooserResourceWidget::GetOriginalDatabaseTableId()
{
    return OriginalDatabaseTableId;
}

void DesignChooserResourceWidget::SetOriginalDatabaseTableId(int OriginalDatabaseTableId)
{
    this->OriginalDatabaseTableId = OriginalDatabaseTableId;
}
...
{
    OriginalDatabaseColumnsIds = ColumnIds;
    DatabaseDrag->Clear();
    QList<int> Selected;
    QStringList Columns;
