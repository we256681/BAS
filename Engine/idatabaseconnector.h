...
namespace BrowserAutomationStudioFramework
{
    ...
    public:
        ...
        virtual DatabaseItem Select(const QString& Id, int TableId) = 0;
        ...
        virtual void Update(DatabaseItem Item, DatabaseMassSelector Selector) = 0;
        ...
        virtual DatabaseSelector ConvertToDatabaseSelector(const QVariant& Data) = 0;
