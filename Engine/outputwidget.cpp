...
{
    ui->setupUi(this);
    ui->TooltipContainer->setVisible(false);
    ui->Border1->setVisible(false);
    ui->Border2->setVisible(false);
...
void OutputWidget::SetTooltipVisible(bool Visible)
{
    ui->TooltipContainer->setVisible(Visible);
    ui->Border1->setVisible(Visible);
    ui->Border2->setVisible(Visible);
}
