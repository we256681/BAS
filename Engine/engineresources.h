...
namespace BrowserAutomationStudioFramework
{
    ...
    public slots:
        ...
        virtual QStringList GetNames();
        virtual QList<QScriptValue> GetAllData(const QString & name);
        virtual QJsonValue GetDescription(const QString & name);
        ...
        virtual void Clear(const QString & name);
        virtual void Remove(const QString & name);
        virtual void RemoveIndex(const QString & name,int index);
        virtual int Find(const QString & name,const QString& value);
        virtual QList<int> FindByKeys(const QString & name,const QStringList& keys);
