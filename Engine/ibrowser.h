...
namespace BrowserAutomationStudioFramework
{
    ...
    public slots:
        ...
        virtual void DisableBrowser(const QString& callback) = 0;
        virtual INetworkAccessManager* GetNetworkAccessManager() = 0;
        virtual INetworkAccessManager* GetNetworkAccessManagerVirtual() = 0;
        ...
        virtual void DebugCallstackResult(const QString& data, const QString& callback) = 0;
        ...
        virtual void SetDeviceScaleFactor(double scale,const QString& callback) = 0;
        ...
        virtual void SetManualBrowserControl() = 0;
        virtual bool GetManualBrowserControl() = 0;
