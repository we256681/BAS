...
namespace BrowserAutomationStudioFramework
{
    ...
    public:
        ...
        virtual IProfilerData * GetProfilerData() = 0;
        ...
        virtual void SetProcessComunicatorVirtual(IProcessComunicator *ProcessComunicatorVirtual) = 0;
        virtual IProcessComunicator * GetProcessComunicatorVirtual() = 0;

        virtual IProcessComunicator * GetProcessComunicatorActual() = 0;
        ...
        virtual void SetSubstageManager(SubstageManager* _SubstageManager) = 0;
        virtual SubstageManager* GetSubstageManager() = 0;
    ...
    signals:
        ...
        void SendTaskResultRecordSignal(const QString& ResultData);
        void WebInterfaceEvalSignal(const QString& script);
        void SendTaskResultRunSignal(int,QString);
        void PrepareFunctionSignal(QString);

        /* Custom threads */
        void CustomThreadStart(int);
        void CustomThreadRunFunction(int, QString, QString, bool, bool);
        void CustomThreadStop(int);
        void CustomThreadStopList(QString);
        void CustomThreadResult(int, bool, bool, QString, QString);
        void CustomThreadQueueFunction(int, QString, QString, bool, bool, int);
    public slots:
        ...
        virtual void SolveRecaptchaV3(const QString& id, const QString& action, const QString & sitekey, const QString & url) = 0;
        ...
        virtual void SetAsyncFailMessage(const QString & AsyncFailMessage) = 0;
        virtual QString GetAndClearAsyncFailMessage() = 0;

        virtual void SetAsyncDieMessage(const QString & AsyncDieMessage) = 0;
        virtual QString GetAndClearAsyncDieMessage() = 0;
        ...
        virtual void TaskDataReceived(int Id, const QString& FunctionName, const QString& FunctionParams, int ResultId) = 0;
