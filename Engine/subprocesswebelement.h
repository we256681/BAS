...
namespace BrowserAutomationStudioFramework
{
    ...
    class ENGINESHARED_EXPORT SubprocessWebElement : public IWebElement
    {
        ...
        void ConnectElement(IWorker* Worker, IWebElement* Element);
    public:
    ...
    public slots:
        ...
        virtual void script2(const QString& javascript, const QString& variables, const QString& callback);
        ...
        virtual void highlight(const QString& path, const QString& callback);
