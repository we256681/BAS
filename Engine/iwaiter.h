...
namespace BrowserAutomationStudioFramework
{
    ...
    signals:
        void Started();
        void Ended();
        void NeedToWaitForResource(QString);
    public slots:
        virtual void WaitForSignal(const QObject *object_wait, const char * slot_signal ,const QObject *object_success,const char * slot_success,const QObject *object_fail,const char * slot_fail, int ExactTimeout = -1) = 0;
        ...
        virtual void SetReportAboutStartedOrEnded() = 0;
        virtual bool GetReportAboutStartedOrEnded() = 0;
