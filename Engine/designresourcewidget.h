...
namespace BrowserAutomationStudioFramework
{
    ...
    public:
        ...
        void SetDatabaseColumnsIds(const QList<int>& ColumnsIds);


        explicit DesignResourceWidget(QWidget *parent = 0,IResourceWidget * Wrapper = 0);
