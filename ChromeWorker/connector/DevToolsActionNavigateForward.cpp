...
void DevToolsActionNavigateForward::Run()
{
    State = Running;
...
void DevToolsActionNavigateForward::OnWebSocketMessage(const std::string& Message, const std::string& Error)
{
...
void DevToolsActionNavigateForward::OnWebSocketEvent(const std::string& Method, const std::string& Message)
{
